...
export class VodkaRoom extends BaseLocation {
  ...
  public description(): string {
    ...
    return (
      ...
      "Someone was here recently... You see empty glasses and a card game left mid-hand — someone was winning and clearly not worried about it. The Kahlúa has been moved from the shelf to the seat of one of the camp chairs, with a deliberateness that suggests whoever placed it had reasons.\n\n" +
      noteText +
