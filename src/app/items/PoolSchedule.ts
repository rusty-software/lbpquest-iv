...
export class PoolSchedule extends BaseItem {
  ...
  public examine(gameEngine: GameEngine): string {
    ...
    return "A laminated sheet taped to the shed wall, listing pool maintenance intervals by day and hour — chlorine check, filter rinse, backwash cycle. Standard entries for every slot except one:\n\nTUESDAY 7:00 PM — GERALD\n\nNo further explanation. Circled twice in red marker. Someone has added beneath it in smaller letters: Do Not Disturb.";
  }
